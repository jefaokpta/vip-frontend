...
import { Moh, Ura, UraAction, UraActionEnum } from '@/pabx/types';
        ...
        <p-card>
            <ng-template #title>
                <div class="flex justify-between">
                    <span class="font-semibold text-2xl">Editar URA</span>
                    <p-button
                        type="button"
                        label="Voltar"
                ...
                <form [formGroup]="form" (ngSubmit)="onSubmit()" class="p-fluid">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div class="field">
                            ...
                            />
                            @if (
                                form.get('soundId')?.invalid &&
                                (form.get('soundId')?.dirty || form.get('soundId')?.touched)
                            ) {
                    ...
                    <div class="mb-4">
                        ...
                        <div formArrayName="actions">
                            ...
                            >
                                ...
                                <div
                                    class="field"
                                    *ngIf="action.get('uraActionEnum')?.value === UraActionEnum.DIALPEER"
                                >
                                    <app-peer-select-component formControlName="target" [isShowLabel]="true" />
                                </div>
...
export class EditUraPage implements OnInit {
    form!: FormGroup;
    pending = false;
    showError = false;
    ...
    private buildForm(ura: Ura): void {
        this.form = this.fb.group({
            ...
            name: [ura.name, [Validators.required]],
            interactionTimeout: [ura.interactionTimeout, [Validators.required, Validators.min(1)]],
            digitTimeout: [ura.digitTimeout, [Validators.required, Validators.min(1)]],
            soundId: [ura.soundId, [Validators.required]],
            isEnableDialPeer: [ura.isEnableDialPeer],
            invalidAction: this.buildActionGroup(ura.invalidAction),
