...
export default [
    ...
    { path: 'ddrs', component: DdrPage, data: { breadcrumb: 'DDR' } },
    { path: 'ddrs/new', component: NewDdrPage, data: { breadcrumb: 'DDR > Novo' } },
    { path: 'ddrs/edit/:id', component: EditDdrPage, data: { breadcrumb: 'DDR > Editar' } },
