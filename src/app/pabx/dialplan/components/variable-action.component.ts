        ...
        <p-panel header="Define Variável de Controle" [toggleable]="true" toggler="header" collapsed>
            <div class="flex flex-col gap-4">
                <div class="field">
                    ...
                    <input id="varName" pInputText class="p-inputtext" [(ngModel)]="varName"
                ...
                <div class="field">
                    ...
                    <input id="varValue" pInputText class="p-inputtext" [(ngModel)]="varValue"
...
export class VariableActionComponent implements ControlValueAccessor {
    ...
    onVarValueChange(flags: string): void {
        this.varValue = flags;
        this.varValueChange.emit(flags);
    }
}
