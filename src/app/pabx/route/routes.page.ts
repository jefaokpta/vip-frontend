...
import { Route } from '@/pabx/types/route';
        ...
        <p-card>
            <ng-template #title>
                <div class="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                    <h2 class="text-surface-900 dark:text-surface-0 text-2xl font-semibold mb-4 md:mb-0">Rotas</h2>
                    <div class="inline-flex items-center">
                        ...
                        <p-button icon="pi pi-plus" label="Rota" routerLink="new" outlined class="mx-4" rounded />
                    </div>
                </div>
            </ng-template>
            ...
            >
                ...
                <ng-template pTemplate="emptymessage">
                    ...
                    @if (!loading) {
                        <tr>
                            <td colspan="8" class="text-center p-4">Nenhuma rota encontrada.</td>
                        </tr>
                    }
                </ng-template>
            </p-table>
