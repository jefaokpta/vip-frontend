...
@Component({
    ...
    standalone: true,
    imports: [Button, Dialog, NgIf, PeerSelectComponent, ReactiveFormsModule, Message],
    template: `
            ...
            <p-dialog header="Ative seu ramal" [visible]="true" [modal]="true" [closable]="false">
                <form [formGroup]="form" (submit)="onSubmit()" class="p-fluid">
                    <div class="field mb-4">
                        <app-peer-select-component formControlName="peer" [showError]="true" [isOnlyAvailable]="true" />
                    </div>
