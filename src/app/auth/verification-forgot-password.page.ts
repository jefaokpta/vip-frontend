...
@Component({
    selector: 'app-verification-forgot-password-page',
    imports: [
        ButtonModule,
        RouterModule,
        AppConfigurator,
                    ...
                    <div class="flex flex-col items-center gap-4">
                        ...
                        >
                            <ng-template #footer>
                                ...
                                <ul class="pl-2 ml-2 my-0 leading-normal">
                                    ...
                                    <li *ngIf="password.errors?.['passwordStrength']?.minLength">
                        ...
                        <small
                            *ngIf="password.invalid && (password.dirty || password.touched)"
                            class="p-error block mt-2"
                        >
                            <div *ngIf="password.errors?.['required']">Nova senha é obrigatória.</div>
                        </small>
                        ...
                        <div class="flex gap-4">
                            ...
                            <p-button outlined label="Entrar" routerLink="/" />
                        </div>

                        <small *ngIf="isShowError" class="text-surface-600 dark:text-surface-200"
                            >Código ou Email inválido</small
                        >
                    </div>
                </form>
            </div>
...
export class VerificationForgotPasswordPage implements OnInit {
    ...
    submit(): void {
        ...
        this.userService
            .confirmForgotPassword(this.form.value)
