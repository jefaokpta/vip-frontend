...
@Component({
    selector: 'app-new-voice-assistant-page',
    standalone: true,
    imports: [
        ReactiveFormsModule,
        NgIf,
        ...
        <p-card>
            <ng-template #title>
                <div class="flex justify-between">
                    <span class="font-semibold text-2xl">Novo Assistente de Voz</span>
                    <p-button
                        type="button"
                        label="Voltar"
...
export class NewVoiceAssistantPage implements OnInit {
    form!: FormGroup;
    onSubmitError = false;
    isSubmitting = false;
    startSpeaking = false;
