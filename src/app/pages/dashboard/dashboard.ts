...
import { CallOverviewComponent } from '@/pages/dashboard/components/call-overview.component';
...
@Component({
    ...
    standalone: true,
    imports: [StatsCardsComponent, LastAnalysisComponent, CallOverviewComponent, TemperatureComponent],
    template: `
        <div class="grid grid-cols-12 gap-8">
            <app-stats-cards-component [cdrsInput]="cdrs" />
            <div class="col-span-12 xl:col-span-9">
                <app-call-overview-component [cdrsInput]="cdrs" />
            </div>
