...
export class EditTenantPage implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.tenantId = Number(this.activatedRoute.snapshot.paramMap.get('id'));
        this.tenantService.findById(this.tenantId).then((tenant) => {
    ...
    async onSubmit() {
        ...
        this.tenantService
            .update(this.tenantId, this.form.value)
